...
class ProfilePasswordAuthorizationTest extends TestCase
{
    ...
    {
        $siswa = Siswa::factory()->create(['nis' => '1111', 'password' => 'password_lama']);
        $hashSebelum = $siswa->password;

        $guru = GuruBk::factory()->create();
        Sanctum::actingAs($guru, ['guru']);

        $this->putJson('/api/profile/1111', [
    ...
    {
        $siswa = Siswa::factory()->create(['nis' => '2222', 'password' => 'password_lama']);
        $hashSebelum = $siswa->password;

        $kepsek = Kepsek::factory()->create();
        Sanctum::actingAs($kepsek, ['kepsek']);

        $this->putJson('/api/profile/2222', [
    ...
    public function test_guru_cannot_change_other_profile_fields(): void
    {
        ...
        $siswa = Siswa::factory()->create(['nis' => '3333', 'kelas' => '10 IPA 1', 'alamat' => 'Alamat Lama']);

        $guru = GuruBk::factory()->create();
        Sanctum::actingAs($guru, ['guru']);

        $this->putJson('/api/profile/3333', [
            'kelas' => '11 IPA 1',
    ...
    {
        $siswa = Siswa::factory()->create(['nis' => '4444', 'password' => 'password_lama']);
        $hashSebelum = $siswa->password;

        $admin = Admin::factory()->create();
        Sanctum::actingAs($admin, ['admin']);

        $this->putJson('/api/profile/4444', [
    ...
    {
        $siswa = Siswa::factory()->create(['nis' => '5555', 'password' => 'password_lama']);
        $hashSebelum = $siswa->password;
    ...
    {
        $siswa = Siswa::factory()->create(['nis' => '8888', 'password' => 'password_lama']);
        $hashSebelum = $siswa->password;

        Sanctum::actingAs($siswa, ['siswa']);

        $this->putJson('/api/profile/8888', [
    ...
    {
        $siswa = Siswa::factory()->create(['nis' => '9999', 'password' => 'password_lama']);
        $hashSebelum = $siswa->password;

        Sanctum::actingAs($siswa, ['siswa']);

        $this->putJson('/api/profile/9999', [
    ...
    {
        $siswa = Siswa::factory()->create(['nis' => '1010', 'password' => 'password_lama']);
        $hashSebelum = $siswa->password;

        $admin = Admin::factory()->create();
        Sanctum::actingAs($admin, ['admin']);

        $this->putJson('/api/profile/1010', [
    ...
    {
        Siswa::factory()->create(['nis' => '6666', 'password' => 'password_lama']);
        $penyerang = Siswa::factory()->create(['nis' => '7777']);

        Sanctum::actingAs($penyerang, ['siswa']);

        $this->putJson('/api/profile/6666', [
            'current_password' => 'password_lama',
