@extends('layouts.app')
@section('title', 'Form Kepsek')
@section('heading', $row ? 'Edit Kepsek' : 'Tambah Kepsek')
@section('content')
<div class="card" style="max-width:480px">
<form method="POST" action="{{ $row ? route('admin.kepsek.update', $row->id) : route('admin.kepsek.store') }}">
