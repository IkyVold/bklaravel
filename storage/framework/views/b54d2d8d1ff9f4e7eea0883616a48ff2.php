<?php $__env->startSection('title', 'Informasi / FAQ — Guru BK'); ?>
...
<div class="guru-bk-page">
    ...
    <div class="container">
        <?php echo $__env->make('partials.guru-sidebar', [
            'activeTab' => $activeTab,
        ...
        <div class="guru-main">
            ...
            <div class="content-tabs tab-nav">
                ...
                <a href="<?php echo e(route('guru.informasi')); ?>" class="tab-btn active">💡 Informasi / FAQ</a>
            </div>
            ...
            <div class="table-container" style="margin-top:0">
                <div class="table-header" style="border-bottom:none;padding-bottom:0">
                    ...
                    <div style="display:flex;align-items:center;gap:14px;flex-wrap:wrap">
                        <div style="font-size:13px;color:#5F5E5A"><?php echo e($rows->count()); ?> informasi tersimpan</div>
                        <a href="<?php echo e(route('guru.informasi.create')); ?>" class="btn-cetak" style="background:#16a34a;box-shadow:0 2px 8px rgba(22,163,74,0.25);text-decoration:none">
                ...
                <div class="table-wrap" style="padding:0 0 8px">
                    ...
                    <table id="infoTable">
                        ...
                        <tbody>
                            ...
                            <tr data-judul="<?php echo e(strtolower($row->judul)); ?>"
                                data-isi="<?php echo e(strtolower(\Illuminate\Support\Str::limit($row->isi, 200))); ?>"
                                data-kategori="<?php echo e($row->kategori); ?>">
                                <td style="font-weight:600;max-width:200px"><?php echo e($row->judul); ?></td>
                                <td><span class="badge-tahun"><?php echo e($row->kategori); ?></span></td>
                                <td class="isi-cell"><?php echo e(\Illuminate\Support\Str::limit($row->isi, 120)); ?></td>
                                <td style="white-space:nowrap;font-size:12.5px;color:#5F5E5A">
                                    <?php echo e($row->updated_at ? \Carbon\Carbon::parse($row->updated_at)->format('d/m/Y H:i') : ($row->created_at ? \Carbon\Carbon::parse($row->created_at)->format('d/m/Y') : '–')); ?>

                                </td>
                                <td style="font-size:12.5px"><?php echo e($row->guru_bk ?? 'Guru BK'); ?></td>
                                <td>
                                    <div class="aksi-wrap">
                                        <a href="<?php echo e(route('guru.informasi.edit', $row->id)); ?>" class="btn-aksi-edit">✏️ Edit</a>
                                        <form method="POST" action="<?php echo e(route('guru.informasi.destroy', $row->id)); ?>" style="display:inline;margin:0" onsubmit="return confirm('Hapus informasi ini?')">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\Downloads\bk-full-laravel\resources\views/guru/informasi-index.blade.php ENDPATH**/ ?>