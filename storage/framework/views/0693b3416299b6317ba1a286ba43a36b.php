...
<div class="profile-page">
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li>
                <a href="<?php echo e(route('siswa.profil')); ?>" class="active">
                    <span class="menu-icon">👤</span>
                    <span>Profile</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('siswa.konseling.index')); ?>">
                    <span class="menu-icon">📋</span>
                    <span>History</span>
                </a>
            </li>
            ...
            <div class="card identity-card">
                ...
                <div class="identity-card-body">
                    <div class="profile-avatar-wrap">
                        <?php if($fotoUrl): ?>
                            <img src="<?php echo e($fotoUrl); ?>" alt="<?php echo e($siswa->nama); ?>" class="avatar-img" width="80" height="80" style="width:80px;height:80px;border-radius:50%;object-fit:cover;border:3px solid #fff">
                        <?php else: ?>
                            <div class="avatar-placeholder" style="width:80px;height:80px;border-radius:50%;background:linear-gradient(135deg,#534AB7,#7F77DD);color:#fff;display:flex;align-items:center;justify-content:center;font-size:28px;font-weight:600;border:3px solid #fff"><?php echo e($initial); ?></div>
                        <?php endif; ?>
                        ...
                        <form id="fotoForm" method="POST" action="<?php echo e(route('siswa.profil.update')); ?>" enctype="multipart/form-data" style="display:none">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <input type="file" name="foto" id="fotoInput" accept="image/jpeg,image/png,image/webp">
                        </form>
                    </div>
                    <div class="identity-name"><?php echo e($siswa->nama); ?></div>
                    <div class="identity-role">Siswa</div>
                    <div class="identity-stats">
                        <div class="stat-chip">
                            <div class="stat-chip-value"><?php echo e($siswa->nis ?: '-'); ?></div>
                            <div class="stat-chip-label">NIS</div>
                        </div>
                        <div class="stat-chip">
                            <div class="stat-chip-value"><?php echo e($siswa->kelas ?: '-'); ?></div>
            ...
            <div class="card info-card">
                ...
                <div class="info-list">
                    <div class="info-row">
                        ...
                        <div class="info-value highlight"><?php echo e($siswa->nama ?: '-'); ?></div>
                        <div></div>
                    </div>
                    <div class="info-row">
                        <div class="info-label">NIS</div>
                        <div class="info-value highlight"><?php echo e($siswa->nis ?: '-'); ?></div>
                        <div></div>
                    </div>
                    <div class="info-row">
                        <div class="info-label">Kelas</div>
                        <div class="info-value highlight"><?php echo e($siswa->kelas ?: '-'); ?></div>
                        <div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value <?php echo e($siswa->jenis_kelamin ? '' : 'empty'); ?>">
                            <?php echo e($siswa->jenis_kelamin ?: 'Belum diisi'); ?>

                        </div>
                        <div>
                            <button type="button" class="edit-btn" data-field="jenis_kelamin" data-label="Jenis Kelamin" data-value="<?php echo e($siswa->jenis_kelamin); ?>">Edit</button>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="info-label">Tanggal Lahir</div>
                        <div class="info-value <?php echo e($tglLahir ? '' : 'empty'); ?>">
                            <?php echo e($tglLahir ?: 'Belum diisi'); ?>

                        </div>
                        <div>
                            <button type="button" class="edit-btn" data-field="tanggal_lahir" data-label="Tanggal Lahir" data-value="<?php echo e($siswa->tanggal_lahir?->format('Y-m-d')); ?>">Edit</button>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="info-label">Alamat</div>
                        <div class="info-value <?php echo e($siswa->alamat ? '' : 'empty'); ?>">
                            <?php echo e($siswa->alamat ?: 'Belum diisi'); ?>

                        </div>
                        <div>
                            <button type="button" class="edit-btn" data-field="alamat" data-label="Alamat" data-value="<?php echo e($siswa->alamat); ?>">Edit</button>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="info-label">No. Telepon</div>
                        <div class="info-value <?php echo e($siswa->no_telepon ? '' : 'empty'); ?>">
                            <?php echo e($siswa->no_telepon ?: 'Belum diisi'); ?>

                        </div>
                        <div>
                            <button type="button" class="edit-btn" data-field="no_telepon" data-label="No. Telepon" data-value="<?php echo e($siswa->no_telepon); ?>">Edit</button>
                        </div>
                    </div>
                    <div class="info-row">
                ...
                <div class="action-bar">
                    <a href="<?php echo e(route('siswa.dashboard')); ?>" class="btn btn-primary">🏠 Kembali ke Beranda</a>
    ...
    <div class="modal-content">
        ...
        <form method="POST" action="<?php echo e(route('siswa.profil.update')); ?>" id="editForm">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\Downloads\bk-full-laravel\resources\views/siswa/profile.blade.php ENDPATH**/ ?>