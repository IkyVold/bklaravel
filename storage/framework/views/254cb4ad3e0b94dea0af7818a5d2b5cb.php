...
<div class="status-page">
    <div class="page">
        ...
        <div class="actions">
            ...
            <form method="POST" action="<?php echo e(route('siswa.konseling.destroy', $row->id)); ?>" style="display:inline" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan pengajuan ini dan mengajukan ulang?')">
                <?php echo csrf_field(); ?>
